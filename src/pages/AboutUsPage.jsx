...
const AboutUsPage = () => {
  return (
    <div className="w-full bg-[#f7faf8] py-20">
      <div className="w-[75%] mx-auto">
        ...
        {/* Ana Kurumsal Metin */}
        <div className="bg-white rounded-3xl shadow-sm border border-black/5 p-8 md:p-12">
          <div className="space-y-8 text-gray-700 leading-8 text-[17px]">
            <p>
