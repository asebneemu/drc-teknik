...
const serviceTabs = [
  {
    ...
    path: "/hizmetler/yetkili-servis",
  },
  {
    key: "teknik-servis",
    title: "Teknik Servis",
    desc: "Bakım, onarım ve saha desteği",
    path: "/hizmetler/teknik-servis",
  },
  {
    key: "kalibrasyon",
    title: "Kalibrasyon",
    desc: "Doğruluk, hassasiyet ve sistem ayarı",
    path: "/hizmetler/kalibrasyon",
  },
];
  ...
  return (
    <div className="w-full bg-[#f7faf8] py-14 sm:py-16 lg:py-20">
      <main className="mx-auto w-[88%] max-w-7xl">
        ...
        <Routes>
          <Route index element={<Navigate to="yetkili-servis" replace />} />
          <Route path="yetkili-servis" element={<YetkiliServis />} />
          <Route path="teknik-servis" element={<TeknikServis />} />
          <Route path="kalibrasyon" element={<Kalibrasyon />} />
        </Routes>
      </main>
    </div>
  );
