const LocationMapCard = () => {
  return (
    <div className="w-full h-full bg-white rounded-2xl shadow-md overflow-hidden border border-black/5">
      <div className="p-4 sm:p-5 lg:p-6 border-b border-black/5">
        <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2">
          Konumumuz
        </h2>
        <p className="text-gray-600 leading-6 sm:leading-7 text-xs sm:text-sm">
          Bizi harita üzerinden kolayca bulabilir, konumumuza hızlıca ulaşabilirsiniz.
        </p>
      </div>

      <div className="w-full h-[260px] sm:h-[320px] md:h-[360px] lg:h-[380px]">
        <iframe
